...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	ropeJointDef1.localAnchorB = b2Vec2(-1.0f, 0.0f);	// -1 ~ 1
	...
	ropeJointDef2.localAnchorB = b2Vec2(-1.0f, 0.0f);	// -1 ~ 1
	...
	ropeJointDef3.localAnchorB = b2Vec2(-1.0f, 0.0f);	// -1 ~ 1
	ropeJointDef3.maxLength = 1.0f;
	ropeJointDef3.collideConnected = false;
	_world->CreateJoint(&ropeJointDef3);

	ropeJointDef4.bodyA = body5;
	ropeJointDef4.bodyB = body4;
	ropeJointDef4.localAnchorA = b2Vec2(-1.0f, 0.0f);
	ropeJointDef4.localAnchorB = b2Vec2(1.0f, 0.0f);	// -1 ~ 1
...
// 이런 바디들이 촘촘히 이어져 있다면 "Cut the Rope" 같은 게임이 되는 것이다.