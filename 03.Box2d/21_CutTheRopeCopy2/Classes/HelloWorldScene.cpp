...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	Sprite* bg1 = Sprite::createWithSpriteFrameName("bg.png");
	...
	// 아이템 추가
	b2Body* body1 = this->createCandyAt(Vec2(winSize.width / 2, winSize.height * 2 / 3) ,true);
	
	crocMouth_ = this->addNewSprite(Vec2(250, 70), Size(50, 20), b2_staticBody, nullptr, 0);
...
b2Body* HelloWorld::createCandyAt(Vec2 pt, bool userData)
{
