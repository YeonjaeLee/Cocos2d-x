...
bool HelloWorld::createBox2dWorld(bool debug)
{
	...
	//b2Body *bodyA = this->addNewSprite(Vec2(200, 300), Size(40, 40), b2_staticBody, "test", 0);
	//b2Body *bodyB = this->addNewSprite(Vec2(300, 300), Size(40, 40), b2_staticBody, "test", 0);
	...
	pulleyJointDef.Initialize(body1,
		...
		body2->GetPosition(),
		1);
	pulleyJointDef.lengthA = 160 / PTM_RATIO;	// 약 160 .. 200이라 중력의 영향으로 아래로 떨어졌다.
