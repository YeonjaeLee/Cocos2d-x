...
bool HelloWorld::init()
{
	...
	this->SpriteProgressToRadial();					// 반시계방향
	//this->SpriteProgressToHorizontal();				// 오른->왼
	//this->SpriteProgressToVertical();					// 위아래,아래위
	//this->SpriteProgressToRadialMidpointChanged();		// 시계방향 타이머
	//this->SpriteProgressBarVarious();					// 안->바깥 타이머
	//this->SpriteProgressBarTintAndFade();				// 안->바깥 깜빡깜빡 색깔바뀜
