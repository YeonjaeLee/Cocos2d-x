...
bool HelloWorld::init()
{
	...
	// 타일맵 읽어오기
	tmap = TMXTiledMap::create("TileMaps/RunCliff.tmx");
...
void HelloWorld::createWoman()
{
	...
	// 스프라이트 생성 및 초기화
//	woman = Sprite::createWithTexture(texture, Rect(0, 0, 130, 140));
	woman = Sprite::create("Images/grossinis_sister1.png");
	woman->setPosition(womanPosition);
	this->addChild(woman);
...
void HelloWorld::onTouchEnded(Touch* touch, Event* event)
{
	...
	Vec2 playerPos = woman->getPosition();
	...
	this->setViewpointCenter(woman->getPosition());
}
